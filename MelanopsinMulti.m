...
function [tout Mout Xout max_chan maxchan_time] = MelanopsinMulti(dataset)
...
for counter=1:maxcounter
    ...
    if X(12) == 0 && tracker2 ==0
        kSkeeper = kS
        kS = 0.00*kS;
        % This might need to be revisited if we're repooling closed channels
        % Might just either have kS be dependent on concentration of kS or cap it.
...
% Channel Opening/Closing
    ...
    h(40) = K(10)*X(13);            % SecM.Channel+ -- kC --> The Ether %% This needs to change
