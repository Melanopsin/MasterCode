...
% Kinase Phosphorylation
    ...
    h(49) = 0*K(13)*M(17);            % M2*K + ATP -- kk3 --> M3*K + ADP
    
    h(50) = 0*K(11)*M(20);            % M3* + K -- kk1 --> M3*K 
    h(51) = 0*K(12)*M(24);            % M3*K -- kk2 --> M3* + K
    h(52) = 0*K(13)*M(24);            % M3*K + ATP -- kk3 --> M4*K + ADP
    
    h(53) = 0*K(11)*M(27);            % M4* + K -- kk1 --> M4*K 
    h(54) = 0*K(12)*M(31);            % M4*K -- kk2 --> M4* + K
    h(55) = 0*K(13)*M(31);            % M4*K + ATP -- kk3 --> M5*K + ADP
    
    h(56) = 0*K(11)*M(34);            % M5* + K -- kk1 --> M5*K 
    h(57) = 0*K(12)*M(38);            % M5*K -- kk2 --> M5* + K
    h(58) = 0*K(13)*M(38);            % M5*K + ATP -- kk3 --> M6*K + ADP
            
    h(59) = 0*K(11)*M(41);            % M6* + K -- kk1 --> M6*K 
...
% Arrestin Binding
    ...
    h(65) = 0*W(3)*K(14)*M(20)*X(11)*slowmedown;       % M3* + ArrB1 -- kB1*w(n) --> M3.ArrB1
    h(66) = 0*W(3)*K(15)*M(20)*X(12)*slowmedown;       % M3* + ArrB2 -- kB2*w(n) --> M3.ArrB2
...
% Arrestin unbinding and deactivation
    ...
    h(78) = 0*W(3)*K(20)*M(25);       % M3.ArrB1 -- kUB1 --> MP + ArrB1
    ...
    h(84) = 0*W(3)*K(21)*M(26);       % M3.ArrB2 -- kUB2 --> MP + ArrB2
...
save('results.mat','tstore','Time','Mstore','Xstore','reaction_count','seed_name');
...
save('results.mat','Time','tstore','Mstore','Xstore','Mopchan','Sopchan','Mratio','Sratio','reaction_count','seed_name');
...
GproteinActivation = [hh(1) hh(6) hh(11) hh(2) hh(7) hh(12) hh(3) hh(8) ...
    hh(13) hh(4) hh(9) hh(14) hh(5) hh(10) hh(15)];
KinasePhosphorylation = [hh(41) hh(44) hh(47) hh(42) hh(45) hh(48) hh(43) hh(46)];
ArrestinBindingUnbinding = [hh(61) hh(63) hh(62) hh(64) hh(76) hh(77) hh(82) hh(83) h(88)];
...
set(gca,'XTickLabel',{'kG1y(0)';'kG1y(1)';'kG1y(2)';'kG2(0)';'kG2(1)';'kG2(2)';...
    'kG3(0)';'kG3(1)';'kG3(2)';'kG4(0)';'kG4(1)';'kG4(2)';'kG5(0)';'kG5(1)';'kG5(2)'})
set(gcf,'color','w');
grid on
box on
hold off
...
set(gca,'XTickLabel',{'kk1(0)';'kk1(1)';'kk1(2)';'kk2(0)';'kk2(1)';'kk2(2)';'kk3(0)';'kk3(1)'})
set(gcf,'color','w');
grid on
box on
hold off
...
set(gca,'XTickLabel',{'kB1w(1)';'kB1w(2)';'kB2w(1)';'kB2w(2)';'kUB1w(1)';'kUB1w(2)';'kUB2w(1)';'kUB2w(2)';'kDe'})
set(gcf,'color','w');
grid on
box on
hold off  
