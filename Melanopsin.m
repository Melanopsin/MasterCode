...
for counter=1:maxcounter
    ...
    % Speeds up the rate of channel closing if turned on
    ...
    % Turns off SecM production after all of the closed channels are opened
...
figure(2)
plot(tstore, Xstore(:,13)/max(Xstore(:,13)))
