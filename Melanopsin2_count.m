...
% It will run the Gillespie algorithm code
...
totrun=10
dataset=6
tmax=60 % final time for each run
flashint=100
...
max_chan = 0;  % sets up a counter for calculating the maximum number of open channelsv (i.e., X(8)) 
maxchan_time = 0;  %initalizes the time it takes for all channels to open
...
%% New
    ...
    elseif sum(hw(1:75)) < r && r <= sum(hw(1:76))
        ...
        X(11) = X(11) + 1;
        M(49) = M(49) + 1;
        reaction_count(76,1) = reaction_count(76,1) + 1;

    elseif sum(hw(1:76)) < r && r <= sum(hw(1:77))
        M(18) = M(18) - 1;
        X(11) = X(11) + 1;
        M(49) = M(49) + 1;
        reaction_count(77,1) = reaction_count(77,1) + 1;

    elseif sum(hw(1:77)) < r && r <= sum(hw(1:78))
        M(25) = M(25) - 1;
        X(11) = X(11) + 1;
        M(49) = M(49) + 1;
        reaction_count(78,1) = reaction_count(78,1) + 1;

    elseif sum(hw(1:78)) < r && r <= sum(hw(1:79))
        M(32) = M(32) - 1;
        X(11) = X(11) + 1;
        M(49) = M(49) + 1;
        reaction_count(79,1) = reaction_count(79,1) + 1;

    elseif sum(hw(1:79)) < r && r <= sum(hw(1:80))
        M(39) = M(39) - 1;
        X(11) = X(11) + 1;
        M(49) = M(49) + 1;
        reaction_count(80,1) = reaction_count(80,1) + 1;

    elseif sum(hw(1:80)) < r && r <= sum(hw(1:81))
        M(46) = M(46) - 1;
        X(11) = X(11) + 1;
        M(49) = M(49) + 1;
        reaction_count(81,1) = reaction_count(81,1) + 1;

    elseif sum(hw(1:81)) < r && r <= sum(hw(1:82))
        M(12) = M(12) - 1;
        X(12) = X(12) + 1;
        M(49) = M(49) + 1;
        reaction_count(82,1) = reaction_count(82,1) + 1;

    elseif sum(hw(1:82)) < r && r <= sum(hw(1:83))
        M(19) = M(19) - 1;
        X(12) = X(12) + 1;
        M(49) = M(49) + 1;
        reaction_count(83,1) = reaction_count(83,1) + 1;

    elseif sum(hw(1:83)) < r && r <= sum(hw(1:84))
        M(26) = M(26) - 1;
        X(12) = X(12) + 1;
        M(49) = M(49) + 1;
    reaction_count(84,1) = reaction_count(84,1) + 1;

    elseif sum(hw(1:84)) < r && r <= sum(hw(1:85))
        M(33) = M(33) - 1;
        X(12) = X(12) + 1;
        M(49) = M(49) + 1;
        reaction_count(85,1) = reaction_count(85,1) + 1;

    elseif sum(hw(1:85)) < r && r <= sum(hw(1:86))
        M(40) = M(40) - 1;
        X(12) = X(12) + 1;
        M(49) = M(49) + 1;
        reaction_count(86,1) = reaction_count(86,1) + 1;

    elseif sum(hw(1:86)) < r && r <= sum(hw(1:87))
        M(47) = M(47) - 1;
        X(12) = X(12) + 1;
        M(49) = M(49) + 1;
        reaction_count(87,1) = reaction_count(87,1) + 1;

    elseif sum(hw(1:87)) < r && r <= sum(hw(1:88))
        M(48) = M(48) + 1;
        M(49) = M(49) - 1;
        reaction_count(88,1) = reaction_count(88,1) + 1;
...
% %    pause(0.1)
    ...
    %% record the maximal number of channels % Is this if statement necessary?
    if max_chan < X(8)
       max_chan = X(8);
       maxchan_time = t;
    end
...
save('results.mat','Time','reaction_count','tstore','Mstore','Xstore','Mx','Sx','Mm','Sm','max_chan','maxchan_time');
...
% % toc
hold all
plot(Time,opchan./max(opchan),'LineWidth',2)% a ratio of the number of open channels out of the total number of channels
legend('data','model');
% hold on
